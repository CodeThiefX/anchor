      ...
      <main className="relative z-10 px-6 py-12 md:py-24">
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Loan Types */}
            <div className="bg-[#2F2F2F]/40 rounded-[30px] overflow-hidden p-10">
              <div className="grid grid-cols-2 divide-x divide-white/30">
                <div className="grid grid-rows-2 divide-y divide-white/30">
                  {/* Personal Loan */}
                  <div className="py-6 space-y-2 flex justify-center items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-xl">Personal Loan</h3>
                  ...
                  <div className="py-6 space-y-2 flex justify-center items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-xl">Business Loan</h3>
                      <p className="text-white text-sm leading-relaxed">
                ...
                <div className="grid grid-rows-2 divide-y divide-white/30">
                  {/* Home Loan */}
                  <div className="py-6 pl-6 space-y-2 flex justify-center items-center gap-4">
                    <div className="rounded-lg">
                      <Image
                    ...
                    <div>
                      <h3 className="font-semibold text-xl">Home Loan</h3>
                      <p className="text-white text-sm leading-relaxed">
                  ...
                  <div className="py-6 pl-6 space-y-2 flex justify-center items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-xl">Auto Loan</h3>
                      <p className="text-white text-sm leading-relaxed">
            ...
            <div className="bg-white text-black rounded-[30px] p-12">
              <h2 className="text-xl mb-8">Select Loan Amount</h2>
